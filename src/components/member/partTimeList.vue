      ...
      <el-table :data="partTimeList" border style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" width="200">
          <template slot-scope="scope">
            ...
            <el-button v-if="scope.row.status == 1" size="small" type="warning" @click="handleChoose(scope.$index, scope.row)">取消选中</el-button>
            <el-button v-else size="small" type="primary" @click="handleChoose(scope.$index, scope.row)">选中</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
